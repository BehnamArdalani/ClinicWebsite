...
if (isset($_POST["patient_name"]) && isset($_POST["address"]) && isset($_POST["cnic"]) && 
    isset($_POST["date_of_birth"]) && isset($_POST["phone_number"]) && isset($_POST["gender"]) ){
      ...
      //die();
        ...
        $newPatient = Patients::create($_POST["patient_name"], $_POST["address"], $_POST["cnic"], $_POST["date_of_birth"], $_POST["phone_number"], $_POST["gender"]);
        $newPatient->save();
...
<head>
 ...
 <?php include './config/data_tables_css.php';?>
  ...
  <title>Patients - Montreal Clinic Management System in PHP</title>
              ...
              class="table table-striped dataTable table-bordered dtr-inline" 
               role="grid" aria-describedby="all_patients_info">
                ...
                <tbody>
                  ...
                  $allPatients = DBContext::Search("Patients");
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="update_patient.php?id=<?php echo $patient->getId(); ?>" class = "btn btn-primary btn-sm btn-flat">
