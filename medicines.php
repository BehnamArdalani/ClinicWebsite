...
if (isset($_POST["medicine_name"])){
      ...
      //die();
        ...
        $newMedicine = Medicines::create($_POST["medicine_name"]);
        $newMedicine->save();
...
<head>
 ...
 <title>Medicines - Montreal Clinic Management System in PHP</title>
</head>
      ...
      <div class="card card-outline card-primary rounded-0 shadow">
        ...
        <div class="card-body">
         ...
         <tbody>
          ...
          $allMedicines = DBContext::Search("Medicines");

          $serial = 0;
          foreach($allMedicines as $midicine) {
           $serial++;
           ?>
           <tr>
             <td class="text-center"><?php echo $serial; ?></td>
             <td><?php echo $midicine->getMedicineName(); ?></td>
             <td class="text-center">
              <a href="update_medicine.php?id=<?php echo $midicine->getId(); ?>" 
